...
type service interface {
	...
	FTJ(f, t string, j json.RawMessage) (b []byte, err error)
	FTV(f, t, v string) (b []byte, err error)
	FTNJ(f, t, n string, j json.RawMessage) (b []byte, err error)
}

// Storage is a persistent service storage.
type Storage interface {
	FTQuery(f, t string) (b []byte, err error)
	FTJQuery(f, t string, j json.RawMessage) (b []byte, err error)
	FTVQuery(f, t, v string) (b []byte, err error)
	FTNJQuery(f, t, n string, j json.RawMessage) (b []byte, err error)
}
...
func (s *basicService) FTJ(f, t string, j json.RawMessage) (b []byte, err error) {
...
func (s *basicService) FTNJ(f, t, n string, j json.RawMessage) (b []byte, err error) {
